export function newFunction_1() {
  ...
  const poniedzialek = [];
    poniedzialek[0] = "0. Język francuski (s.207)";
    poniedzialek[1] = "1. Język polski (s.207)";
    poniedzialek[2] = "2. Historia (s.207)";
    poniedzialek[3] = "3. Geografia (s.207)";
    poniedzialek[4] = "4. Programowanie (s.207)";
    poniedzialek[5] = "5. Matematyka (s.207)";
    poniedzialek[6] = "6. Język angielski (s.103)";
    poniedzialek[7] = "7. Matematyka (s.207)";
    poniedzialek[8] = "8. Pracownia programowania aplikacji (s.306)";
    poniedzialek[9] = "9. Programowanie aplikacji (s.214)";
    poniedzialek[10] = "10. Pracownia programowania aplikacji (s.214)";
    poniedzialek[11] = "11. Pracownia programowania aplikacji (s.214)";
    poniedzialek[12] = "12. Matematyka (s.207)";
  ...
  const wtorek = [];
    ...
    wtorek[7] = "7. Matematyka (s.207)";
    wtorek[8] = "8. Pracownia programowania aplikacji (s.306)";
  ...
  const sroda = [];
    sroda[1] = "1. Religia (s.102)";
    sroda[2] = "2. Programowanie aplikacji (s.220)";
    sroda[3] = "3. Fizyka (s.219)";
  ...
  const czwartek = [];
    czwartek[1] = "1. Język angielski (s.103)";
    czwartek[2] = "2. Historia (s.105)";
    czwartek[3] = "3. Geografia (s.204)";
    czwartek[4] = "4. Testowanie aplikacji (s.312)";
  ...
  const piatek = [];
    piatek[1] = "1. Programowanie aplikacji (s.306)";
    piatek[2] = "2. Pracowania programowania aplikacji (s.306)";
    piatek[3] = "3. Testowanie aplikacji (s.003)";
    piatek[4] = "4. Język polski (s.219)";
    piatek[5] = "5. Matematyka (s.207)";
